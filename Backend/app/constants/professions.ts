...
import {
  Acrobatics,
  AnimalHandling, Arcana, BrewersSupplies, CharismaSavingThrows,
  ConSavingThrows, CooksUtensils, Deception, GlassblowersTools, Handaxes, HeavyArmor, History, Intimidation,
...
import {
  Blowgun, ButchersKnife, CastIronPan,
  Club,
  Dagger,
...
import {
  Abacus, ADozenApples, ALute, ArcaneBook, BeggarCup, Bell, BlockAndTackle, ChainShirt,
  CuredHam, DeadRatBag, DruidicFocusTotem, FineCandles,
  FineCloth, GlassblowersToolsItem, GroceryList,
  HealersKit, HideArmor, HolySymbolEmblem, HolySymbolReliquary, Jerky, LeatherArmor, LeatherworkerTools, Lock,
  MinersTools, MoneySack, NobilityPapers,
  Pick, PortableTrampoline, Ringmail, Rope50Ft,
  SackOfManure, SchoolBook, Shield, Soil,
  SpeakingTrumpet,
  ThievesTools
} from "./items";
...
export const Gladiator = new Profession(2, "Gladiator", "d12 gp", SimpleWeapons, Net, [ChainShirt], Common, ProfessionTypeEnum.Strength);
...
export const Ostler = new Profession(1, "Ostler", "d8 sp", AnimalHandling, Whip, [DruidicFocusTotem], Common, ProfessionTypeEnum.Wisdom);
